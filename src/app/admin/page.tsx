    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Bem-vindo, {session?.user?.name || "Administrador"}. Gerencie o sistema através deste painel.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <DashboardCard 
          title="Todas as Incidências" 
          description="Visualize e gerencie todas as incidências do sistema." 
        ...
        <DashboardCard 
          title="Configurações" 
          description="Configure parâmetros do sistema e personalização." 
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <StatCard title="Usuários" value="--" />
          <StatCard title="Incidências" value="--" />
          <StatCard title="Incidências Abertas" value="--" />
        </div>
      </div>
    </div>
  );

    ...
    <footer className="bg-muted py-12 border-t border-border">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground mb-4 max-w-md">
              Plataforma completa para registro, acompanhamento e resolução de incidências de forma eficiente.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/incidencias" className="text-muted-foreground hover:text-primary transition-colors">
                  Incidências
                </a>
              </li>
              <li>
                <a href="/incidencias/nova" className="text-muted-foreground hover:text-primary transition-colors">
                  Nova Incidência
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">
                  contato@portalincidencias.com.br
                </span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-border mt-12 pt-8 text-center text-muted-foreground text-sm">
          <p>&copy; {currentYear} Portal de Incidências. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
